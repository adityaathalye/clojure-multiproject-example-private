...
(defmulti hydrate-view
  ...
  `:com.adityaathalye.grugstack.system.application/view` context
  information injected into the request map, by middleware. This way,
  we can declare context information at the routing table, and
  conveniently trace route - view relationship."
